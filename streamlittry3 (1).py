...
def generate_option_report(ticker, expiries, max_pain_prices, pinning_probs,
    ...
    report += "👉 股价高于平均痛点价，短期有下行回归压力。\n\n" if current_price > avg_max_pain else "👉 股价低于平均痛点价，可能向上回归至痛点水平。\n\n"
...
if st.sidebar.button("Run Analysis"):
    ...
    max_pain_prices = [current_price-2 for _ in selected_expiries]  # placeholder logic
    pinning_probs = [0.012, 0.007, 0.016]

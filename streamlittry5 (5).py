...
if st.sidebar.button("Run Analysis"):
    ...
    if hist.empty:
        ...
        bs_call = black_scholes_price(current_price, strike_price, forecast_days/252, r, q, 0.2)
        bs_put = black_scholes_price(current_price, strike_price, forecast_days/252, r, q, 0.2, 'put')
